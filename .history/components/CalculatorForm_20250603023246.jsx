...
export default function CalculatorForm() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 justify-center items-start w-full">
      {/* Form Section */}
      <div className="max-w-md w-full mx-auto p-8 bg-gradient-to-br from-green-50 via-white to-blue-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-950 shadow-2xl rounded-2xl border border-gray-200 dark:border-gray-700">
        <h2 className="text-3xl font-extrabold mb-6 text-center text-green-700 dark:text-green-300 tracking-tight">
        ...
        {monthlySavings !== null && (
          <div className="mt-8 bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 shadow-inner text-center">
            ...
            <a
              href="/signup"
              className="inline-block mt-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline font-medium transition"
            >
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <CartesianGrid
                strokeDasharray="3 3"
                stroke="#e5e7eb"
                // Use a darker grid in dark mode
