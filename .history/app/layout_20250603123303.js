          ...
          <ThemeProvider>
            ...
            <header className="flex justify-between items-center px-8 py-6 bg-white/80 dark:bg-zinc-800/80 shadow-xl border-b border-green-100 dark:border-zinc-700">
              ...
              <div className="flex items-center gap-4">
                ...
                <SignedOut>
                  <SignInButton>
                    <button className="px-4 py-2 rounded-lg max-md:px-2 max-sm:px-0 max-md:py-1 max-sm:py-0 max-md:text-xl max-sm:text-sm bg-green-500 hover:bg-green-600 text-white font-semibold shadow transition">
                      Sign In
                    </button>
                  </SignInButton>
                  <SignUpButton>
                    <button className="px-4 py-2 rounded-lg max-md:px-2 max-sm:px-0 max-md:py-1 max-sm:py-0 max-md:text-xl max-sm:text-sm bg-blue-500 hover:bg-blue-600 text-white font-semibold shadow transition">
                      Sign Up
                    </button>
                  </SignUpButton>
                </SignedOut>
