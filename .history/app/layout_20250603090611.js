      ...
      <html lang="en" suppressHydrationWarning>
        ...
        >
          <ThemeProvider>
            ...
            <main>{children}</main>
            {/* Modern UI Footer */}
            <footer className="w-full mt-12 bg-white/80 dark:bg-zinc-900/80 border-t border-green-100 dark:border-zinc-700 flex flex-col items-center gap-2 transition-colors">
